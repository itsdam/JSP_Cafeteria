...
<body style="background-color : White; font-family: 'Gowun Dodum', sans-serif;">
	<%
		...
		if(session.getAttribute("commentContent") != null) {
			commentContent = (String) session.getAttribute("commentContent");
		}
	...
	<div class="container">
		...
		<form method="post" action="commentUpdateAction.jsp?cafeteriaID=<%=cafeteriaID%>&commentID=<%=commentID%>">
			<table class="table table-striped"
					...
					<tbody style="background-color: white;">
						...
						<td><textarea type="text" class="form-control"
								name="commentContent" maxlength="2048" style= "background-color: white;"><%=request.getParameter("commentContent")%></textarea></td>
				...
				<input type="submit" class="button" value="댓글수정">
				<br>
			</form>
